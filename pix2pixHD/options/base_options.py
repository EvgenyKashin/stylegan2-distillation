...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--blind_spot_size', type=int, default=0, help='Square of this size will be replaced in fake image with corresponding patch of input label')
    ...
    def parse(self, save=True):
        ...
        already_saved = self.opt.continue_train and os.path.isfile(file_name)
